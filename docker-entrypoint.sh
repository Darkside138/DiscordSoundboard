...
sed -i 's/bot_token=*/bot_token='$bottoken'/g' application.properties
sed -i 's/username_to_join_channel=*/username_to_join_channel='$username'/g' application.properties
...
sed -i 's~app.frontend-url=*='$frontendurl'~g' application.properties
